        ...
        if (!is_admin()) {
            ...
            if ('off' !== $google_fonts) {
                wp_enqueue_style(
                    ...
                    'https://fonts.googleapis.com/css?family=Barlow:300,300i,400,400i,500,500i,600,600i,700,700|Merriweather:300,300i,400,400i,700,700i,900,900i',
                    false,
                    null
                );
...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div id="comment-<?php comment_ID(); ?>" class="comment">
        ...
        if ($comment->user_id === $post->post_author) {
            echo '<a href="' . esc_url(get_comment_link($comment->comment_ID)) . '" title="' . __('Comment by post author',
                    'radcliffe') . '" class="by-post-author"> ' . __('(Post author)', 'radcliffe') . '</a>';
        }
        ...
        <div class="comment-inner">
            ...
            <div class="comment-header">
                ...
                <span><a
                        href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>"><?php echo get_comment_date() . ' &mdash; ' . get_comment_time(); ?></a></span>
            ...
            <div class="comment-content">
                ...
                <?php if ('0' == $comment->comment_approved) : ?>
                    ...
                    <p class="comment-awaiting-moderation"><?php __('Your comment is awaiting moderation.',
                            'radcliffe'); ?></p>
    ...
    class Radcliffe_Customize
    {
        ...
        public static function radcliffe_header_output()
        {
            ...
            self::radcliffe_generate_css('.post-content input[type="submit"]:hover', 'background-color',
                'accent_color');
            self::radcliffe_generate_css('.post-content input[type="reset"]:hover', 'background-color', 'accent_color');
            self::radcliffe_generate_css('.post-content input[type="button"]:hover', 'background-color',
                'accent_color');

            self::radcliffe_generate_css('.post-content .has-accent-color', 'color', 'accent_color');
            self::radcliffe_generate_css('.post-content .has-accent-background-color', 'background-color',
                'accent_color');
            ...
            self::radcliffe_generate_css('.content #respond input[type="submit"]:hover', 'background-color',
                'accent_color');
        ...
        {
            wp_enqueue_script('radcliffe-themecustomizer', get_template_directory_uri() . '/js/theme-customizer.js',
                array('jquery', 'customize-preview'), '', true);
        }

        public static function radcliffe_generate_css(
            $selector,
            $style,
            $mod_name,
            $prefix = '',
    ...
    if (!function_exists('radcliffe_block_editor_styles')) :
        ...
        function radcliffe_block_editor_styles()
        {
            ...
            if ('off' !== $google_fonts) {
                ...
                wp_register_style('radcliffe-block-editor-styles-font',
            ...
            wp_enqueue_style('radcliffe-block-editor-styles',
                get_theme_file_uri('/radcliffe-gutenberg-editor-style.css'), $dependencies, '1.0', 'all');
